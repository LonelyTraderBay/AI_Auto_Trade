...
- Task hiện hành: **1.2 — OMS deterministic state machine** (`tasks/active/1.2-oms-state-machine.yaml`, `READY`), branch `task/1.2-*`; local simulator/no venue, không durable DB submit/ledger runtime.
