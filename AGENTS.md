...
- Task hiện hành: **0.6 — Capability draft** (`tasks/active/0.6-capability-draft.yaml`, `IN_PROGRESS`), Account Owner xác nhận local simulator/no venue `2026-08-11T02:26:26Z`; chỉ được sửa đúng allowlist docs/evidence, không viết implementation code.
