...
- [x] Account Owner accepts at-least-once semantics and explicit duplicate handling.
- [x] DATA-003/DATA-005 exact table/transaction proposal is approved.
- [x] Contract registry names event schema, partition key, producer/consumer and compatibility test before an event is used.
