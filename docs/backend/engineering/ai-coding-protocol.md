...
3. Implement **giải pháp đơn giản nhất pass được acceptance commands** trong allowed paths; không opportunistic refactor, không generalize ngoài yêu cầu card. Refactor chỉ bắt buộc khi chính diff của task đẩy module vượt ngân sách ENG-PY-001 §5a — khi đó tách/thu gọn trong cùng task, không mở rộng scope.
