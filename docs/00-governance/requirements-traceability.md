...
| Related ADR | ADR-0001 đến ADR-0015 theo phạm vi/deadline |
...
| SEC-AI-001 | ADR-0008 | LLM provider/proposal/memory schema | ai_memory; contract, negative-security test | Phase 6 gate |
