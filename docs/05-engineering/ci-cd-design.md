# ENG-004 — CI/CD design và quality gates
...
| Change summary | Thiết kế pipeline và enforcement trước khi workflow implementation được tạo ở Task 0.1/0.2. |
...
- Detect secrets, dependency vulnerabilities, license policy, SAST; image scan/SBOM chỉ từ khi có image.
