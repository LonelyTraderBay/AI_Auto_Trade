...
| Change summary | 0.2.0 (2026-08-02): bổ sung trường "ADR liên kết" bắt buộc vào quy tắc §1.3 và cột ADR vào register — master §15.3/§14.2 yêu cầu waiver phải có ADR nhưng register trước đây thiếu (audit toàn diện). |
...
3. Mỗi waiver phải có đủ: phạm vi chính xác (file/test/rule), lý do, compensating control, **ADR liên kết** (master §15.3: "Waiver phải có ADR"; §14.2: "Waiver: chỉ có ADR + Account Owner"), approver đúng RACI, ngày cấp và **expiry bắt buộc** (UTC). Không có waiver vô thời hạn.
...
| Waiver ID | Phạm vi (file/rule/test) | Lý do | Compensating control | ADR liên kết | Approver (role) | Cấp (UTC) | Expiry (UTC) | Trạng thái |
|---|---|---|---|---|---|---|---|---|
...
|---|---|---|---|---|
| 0.2.0 | 2026-08-02 | Bổ sung trường/cột "ADR liên kết" bắt buộc theo master §15.3 và §14.2 (audit toàn diện phát hiện thiếu); thêm row Change summary vào header. | Technical Operator | Pending |
