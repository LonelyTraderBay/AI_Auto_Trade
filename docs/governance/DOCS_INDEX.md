...
| Master authority | [AI_AUTO_TRADE_MASTER_SPEC.md](../../AI_AUTO_TRADE_MASTER_SPEC.md) v2.4.4 |
...
| Task controls | [tasks/active/](../../tasks/active/) · [tasks/completed/](../../tasks/completed/) | 0.0.0–0.0.7 DONE; 0.5.1/0.5.2/0.6/1.1/1.2/1.3 DONE; [Task 1.3 card](../../tasks/completed/1.3-durable-submit-fake-venue.yaml) DONE; [Task 1.3.1 evidence redaction cleanup](../../tasks/active/1.3.1-evidence-secret-redaction.yaml) REVIEW; [Task 1.3.2 durable-submit hardening](../../tasks/active/1.3.2-durable-submit-hardening.yaml) BLOCKED pending one-time owner approval; OD-001 external venue OPEN |
