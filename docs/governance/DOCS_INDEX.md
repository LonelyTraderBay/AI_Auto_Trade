...
| Master authority | [AI_AUTO_TRADE_MASTER_SPEC.md](../../AI_AUTO_TRADE_MASTER_SPEC.md) v2.2.9 |
| Change summary | 0.13.1 (2026-08-11): Bắt đầu thực thi Task 0.6 lúc 2026-08-11T02:29:48Z; card chuyển READY → IN_PROGRESS sau khi tạo capability matrix draft docs-only; OD-001 external venue vẫn OPEN. |
...
| Task controls | [tasks/active/](../../tasks/active/) · [tasks/completed/](../../tasks/completed/) | 0.0.0–0.0.7 DONE; 0.5.1/0.5.2 DONE; 0.6 IN_PROGRESS (local simulator/no venue); OD-001 external venue OPEN |
