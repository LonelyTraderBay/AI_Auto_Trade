...
| Change summary | 0.14.18 (2026-08-12): ghi nhận one-time approval record, reconcile card 0.0.7 sang `tasks/completed/`, tạo canonical Task 1.3 card ở `BLOCKED` và đồng bộ control panel; branch đã tạo, tree sạch, chưa mở code vì thiếu PostgreSQL no-skip. 0.14.17: bổ sung P-68 và Security/Backup Owner sign-off. |
