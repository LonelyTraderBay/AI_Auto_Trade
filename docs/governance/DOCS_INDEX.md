...
| Master authority | [AI_AUTO_TRADE_MASTER_SPEC.md](../../AI_AUTO_TRADE_MASTER_SPEC.md) v2.3.6 |
| Change summary | 0.14.6 (2026-08-12): Account Owner phê duyệt baseline DOM-OMS-001, DATA-TXN-001 và DOM-ACC-001 lúc 2026-08-11T19:52:15Z; mở Task 1.2 OMS deterministic state machine READY, giữ accounting annex/venue deferred. |
...
| Task controls | [tasks/active/](../../tasks/active/) · [tasks/completed/](../../tasks/completed/) | 0.0.0–0.0.7 DONE; 0.5.1/0.5.2/0.6/1.1 DONE; 1.2 READY (OMS deterministic state machine); OD-001 external venue OPEN |
...
| Task evidence | [docs/governance/evidence/tasks/](evidence/tasks/) | IN_REVIEW — gồm evidence 0.1–0.6, Task 1.1 deterministic primitives và Task 1.2 khi triển khai; Task 0.6 Owner approval `2026-08-11T19:16:45Z`; Task 1.1 Owner approval `2026-08-11T19:41:38Z` |
