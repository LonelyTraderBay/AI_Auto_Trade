...
| Master authority | [AI_AUTO_TRADE_MASTER_SPEC.md](../../AI_AUTO_TRADE_MASTER_SPEC.md) v2.4.3 |
...
| Task controls | [tasks/active/](../../tasks/active/) · [tasks/completed/](../../tasks/completed/) | 0.0.0–0.0.7 DONE; 0.5.1/0.5.2/0.6/1.1/1.2/1.3 DONE; [Task 1.3 card](../../tasks/completed/1.3-durable-submit-fake-venue.yaml) DONE on `task/1.3-durable-submit-fake-venue-after-redaction`; [Task 1.3.1 evidence redaction cleanup](../../tasks/active/1.3.1-evidence-secret-redaction.yaml) REVIEW on dedicated branch after separate Security/Backup Owner action; no `BLOCKED` card remains in `tasks/active/`; OD-001 external venue OPEN |
