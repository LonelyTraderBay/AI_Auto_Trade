...
|---|---|---|---|
| [0001](../../backend/adr/0001-modular-monolith.md) | Modular monolith | Phase 0.0 gate | DRAFT |
| [0002](../../backend/adr/0002-hexagonal-architecture.md) | Hexagonal architecture and composition root | Phase 0.0 gate | DRAFT |
| [0003](../../backend/adr/0003-persistence-strategy.md) | PostgreSQL/Parquet persistence | Phase 0.0 gate | DRAFT |
| [0004](../../backend/adr/0004-outbox-inbox-delivery.md) | Outbox/inbox delivery | Phase 0.0 gate | DRAFT |
| [0005](../../backend/adr/0005-canonical-oms.md) | Canonical OMS/reconciliation | Phase 0.0 gate | DRAFT |
| [0006](../../backend/adr/0006-nautilus-boundary.md) | NautilusTrader boundary | Before runtime use | DRAFT |
| [0007](../../backend/adr/0007-risk-kill-switch-reconciliation.md) | Risk, kill switch and reconciliation | Phase 0.0 gate | DRAFT |
...
| [0011](../../backend/adr/0011-accounting-policy.md) | Accounting policy and ledger invariants | Phase 0.0 gate | DRAFT |
| [0012](../../backend/adr/0012-transaction-concurrency.md) | Transaction/concurrency/fencing | Phase 0.0 gate | DRAFT |
| [0013](../../backend/adr/0013-data-lifecycle-retention.md) | Lifecycle, retention and backup set | Before Phase 2 | DRAFT |
| [0014](../../backend/adr/0014-toolchain-repo-contract-authority.md) | Toolchain/repository/contract authority | Phase 0.0 gate | DRAFT |
...
| [0016](../../backend/adr/0016-provider-neutral-byok-ai-connections.md) | Provider-neutral AI/BYOK catalog, connection and credential boundary | Before Phase 6 | DRAFT |
