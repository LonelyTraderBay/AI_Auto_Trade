...
| Thuộc tính | Giá trị |
|---|---|
| Trạng thái | **Phase 1 — Core safety (IN_PROGRESS)** — Gate Phase 0.0 APPROVED/REVALIDATED 2026-08-10T20:07:02Z. Task 0.1–0.4, 0.0.7, 0.5.1, 0.5.2 và 0.6 DONE; Task 1.1 deterministic primitives READY. OD-001 vẫn OPEN cho external venue. |
...
- Phase 1 — Task 1.1 deterministic primitives: **READY**, branch `task/1.1-*`; chưa OMS/risk/ledger/venue.
