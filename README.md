...
| Thuộc tính | Giá trị |
|---|---|
| Trạng thái | **Phase 1 — Core safety (IN_PROGRESS)** — Gate Phase 0.0 APPROVED/REVALIDATED 2026-08-10T20:07:02Z. Task 0.1–0.4, 0.0.7, 0.5.1, 0.5.2, 0.6 và 1.1 DONE; Task 1.2 OMS deterministic state machine REVIEW chờ Account Owner. OD-001 vẫn OPEN cho external venue; ledger activation còn gated bởi accounting annex. |
...
- Phase 1 — Task 1.2 OMS deterministic state machine: **REVIEW**, branch `task/1.2-*`; implementation/evidence đã hoàn tất, chưa durable DB submit/ledger runtime.
