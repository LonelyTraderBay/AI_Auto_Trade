...
| Thuộc tính | Giá trị |
|---|---|
| Trạng thái | **Phase 0 — Foundation (IN_PROGRESS)** — Gate Phase 0.0 APPROVED/REVALIDATED 2026-08-10T20:07:02Z. Task 0.1–0.4, 0.0.7, 0.5.1 và 0.5.2 DONE; Task 0.6 READY cho capability draft local simulator/no venue. OD-001 vẫn OPEN cho external venue. |
...
- Task 0.6 — Capability draft: **READY**, branch `task/0.6-*`; chỉ tạo matrix local simulator/no venue, không viết runtime/application code.
