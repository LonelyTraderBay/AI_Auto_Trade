...
| Lần rà soát gần nhất | 2026-08-15 |
...
| Thay đổi chính v2.3.5 | Account Owner xác nhận DONE Task 1.1 lúc 2026-08-11T19:41:38Z; chuyển card vào `tasks/completed/`; bước OMS tiếp theo chưa mở vì DOM-OMS-001, DATA-TXN-001 và DOM-ACC-001 còn DRAFT/chờ phê duyệt |
...
| Thay đổi chính v2.4.6 | Bắt đầu implementation Task 1.3.2; card `IN_PROGRESS` trên branch `task/1.3.2-durable-submit-hardening`, giữ nguyên scope local-only hardening |
| Thay đổi chính v2.4.7 | Hoàn tất implementation và evidence Task 1.3.2; card `REVIEW` chờ Account Owner duyệt `DONE`, giữ nguyên scope local-only hardening |
| Thay đổi chính v2.4.8 | Account Owner xác nhận Task 1.3.2 `REVIEW → DONE` lúc 2026-08-14T17:03:06Z; chuyển card vào `tasks/completed/`, giữ nguyên scope/allowlist/ADR/contract/non-goals và không mở ledger, external venue hoặc AI execution |
| Thay đổi chính v2.4.9 | Chuẩn bị Enterprise-Grade one-time approval packet; đồng bộ ADR registry với content status và ghi nhận quality/PostgreSQL no-skip evidence; không mở Phase 1 gate, ledger, external venue hoặc AI execution |
| Thay đổi chính v2.5.0 | Account Owner approve Enterprise-Grade one-time approval packet bounded Local Phase 1 lúc 2026-08-14T21:24:41Z; giữ nguyên ledger/external venue/live/AI locks và yêu cầu task card READY riêng cho implementation tiếp theo |
...
| Việc kế tiếp | Chưa có card `READY`; mở task card tiếp theo với allowlist riêng nếu có scope được phê duyệt | Account Owner | Enterprise-Grade packet đã APPROVED bounded Local Phase 1; không mở venue/ledger/live/AI |
...
| Blocker code | Task 0.1–0.4, 0.0.7, 0.5.1, 0.5.2, 0.6, 1.1, 1.2, 1.3, 1.3.1 và 1.3.2 DONE; Enterprise-Grade packet APPROVED bounded Local Phase 1; ledger runtime còn gated bởi accounting annex; external venue vẫn BLOCKED bởi OD-001 | Account Owner | §14, §16, [approved one-time packet](docs/governance/evidence/tasks/1.3.2/enterprise-grade-one-time-approval-packet-2026-08-15.md), [Account Owner packet approval](docs/governance/evidence/tasks/1.3.2/enterprise-grade-owner-approval-2026-08-14.md), [Task 1.3.2 card](tasks/completed/1.3.2-durable-submit-hardening.yaml) |
| Blocker live | Venue, jurisdiction, account, risk cap chưa chốt | Account Owner | §15.2 và Open Decision Register |
| Lần rà soát | 2026-08-15 | Technical Operator | v2.5.0; Account Owner approved bounded Local Phase 1 packet at 2026-08-14T21:24:41Z; local simulator/no venue; ledger annex và OD-001 vẫn gated |
